...
pmp(8) = uicontrol(f,'Style','pushbutton','String','< 8',...
    'Position',[LargeurFig*0.62 HauteurFig*0.22 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
pmp(1) = uicontrol(f,'Style','pushbutton','String','^ 1',...
    'Position',[LargeurFig*0.39 HauteurFig*0.15 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
pmp(2) = uicontrol(f,'Style','pushbutton','String','^ 2',...
    'Position',[LargeurFig*0.57 HauteurFig*0.15 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
pmp(3) = uicontrol(f,'Style','pushbutton','String','^ 3',...
    'Position',[LargeurFig*0.69 HauteurFig*0.15 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
pmp(4) = uicontrol(f,'Style','pushbutton','String','^ 4',...
    'Position',[LargeurFig*0.87 HauteurFig*0.15 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
pmp(5) = uicontrol(f,'Style','pushbutton','String','< 5',...
    'Position',[LargeurFig*0.46 HauteurFig*0.07 70 30],'Fontsize',13,'BackgroundColor',[0.94 0.94 0.94],'Callback',{@changeState});
