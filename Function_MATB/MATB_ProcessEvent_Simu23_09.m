...
function [MATB_DATA]=MATB_ProcessEvent_Simu23_09(MATB_DATA,lE) % ----on a rajouté Bool perf en argument
...
%     send_log('COMM PLAY',Fich);
    send_log('COMM PLAY',Fich,1); % ----------------- 3e argument égal à 1 car on a rajouté un argument à la fonction send log pour lui introduire  Bool_com + bool_perf
