...
%         t_start=round(linspace(30,240,N_Panne))+randi([-20 20],1,N_Panne); % Depart des pannes
        t_start=round(linspace(30,(t_Max-(t_Max/5)),N_Panne))+randi([-20 20],1,N_Panne); % Depart des pannes, Modifie pour permettre des scenarii de differentes durees -- AL
