...
pop_waiter(["Appuyez sur la touche 'ENTREE' pour commencer le premier entrainement"],1); MATB_Main ; Performance
...
pop_waiter(["Appuyez sur la touche 'ENTREE' pour commencer le deuxieme entrainement", ...
    "(Appuyez sur la touche 'ENTREE' pour commencer)"],1); MATB_Main; Performance
MATB_DATA.ScenarioNumber=MATB_DATA.ScenarioNumber+1; 
